...
<html>
    ...
    <body>
        <div id="a1">
            ...
            <div id="b1">
                 <a href="StudentReg.jsp"><font color="white"size="4px">Sign Up</font></a>
                    &nbsp;&nbsp;&nbsp;<a href="index.jsp">
        ...
        <div id="c">
            <div id="c1">
            <div id="c11"><font color="white">Student Login</font></div>
           </div> 
            <div id="form1">
                <form method="post"name="f1"action="LogSave.jsp">
